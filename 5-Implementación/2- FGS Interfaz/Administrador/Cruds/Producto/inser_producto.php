...
<div class="card" style="width: 28rem; background-color:rgba(255, 255, 255, 0.89)"  >
    <div class="card-body" >
        <br>
        <h1 style="color:black;"> Producto </h1>
        <form method="post" action="controlador_producto_in.php" >
                ...
                <label for="">Nombre producto:</label>
                    <input type="text" name="n2" class="form-control"  placeholder="Nombre" style="width: 20rem; background-color:rgb(255, 255, 255); color: black" required="required">
                </div> 
                <div class="form-group">
                <label for="">Imagen producto (Insertar direccion de la imagen):</label>
                    <input type="text" name="n3" class="form-control"  placeholder="imagen" style="width: 20rem; background-color:rgb(255, 255, 255); color: black" required="required">
                </div>
                <div class="form-group">
                <label for="">Fecha Vencimiento (aaaa/mm/dd):</label>
                    <input type="text" name="n4" class="form-control"  placeholder="Fecha V" style="width: 20rem; background-color:rgb(255, 255, 255); color: black" required="required">
                </div>
                <<div class="form-group">
                <label for="">Precio (10000):</label>
                    <input type="text" name="n5" class="form-control"  placeholder="Precio" style="width: 20rem; background-color:rgb(255, 255, 255); color: black" required="required">
                </div>
				<div class="form-group">
                <label for="">Marca:</label>
                    <input type="text" name="n6" class="form-control"  placeholder="Marca" style="width: 20rem; background-color:rgb(255, 255, 255); color: black" required="required">
                </div>
				<div class="form-group">  
                <label for="">Proveedor:</label>          
                <select type="text" class="form-control"  name="n7"  style="width: 20rem" required="required">
                <?php
