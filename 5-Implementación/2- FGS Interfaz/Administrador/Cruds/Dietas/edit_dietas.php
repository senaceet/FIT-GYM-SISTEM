...
<nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #00000000;" >
	...
	<div class="container">
		<div class="content">
			...
			$sql = mysqli_query($con, "SELECT * FROM fgs_dietas WHERE id_dietas='$nik'");
			...
			?>
			<form method="post" action="controlador_dietas_ed.php" >
				<div class="form-group">
					<label class="col-sm-3 control-label" style="color: rgb(112, 200, 216)">ID</label>
					<div class="col-sm-2">
						<input type="text" name="n1" value="<?php echo $row ['id_dietas']; ?>" class="form-control" required>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-3 control-label" style="color: rgb(112, 200, 216)">Nombre Dieta</label>
					<div class="col-sm-4">
						<input type="text" name="n2" value="<?php echo $row ['nombre_dietas']; ?>" class="form-control"  required>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-3 control-label" style="color: rgb(112, 200, 216)">Tipo Dieta</label>
					<div class="col-sm-4">
						<input type="text" name="n3" value="<?php echo $row ['tipo_dietas']; ?>" class="form-control"  required>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-3 control-label" style="color: rgb(112, 200, 216)">Duracion Dieta</label>
					<div class="col-sm-4">
						<input type="text" name="n4" value="<?php echo $row ['duracion_dietas']; ?>" class="form-control"  required>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-3 control-label" style="color: rgb(112, 200, 216)">Descripcion Dieta</label>
					<div class="col-sm-4">
						<textarea name="n5" rows="10" cols="50" style="width: 20rem;"><?php echo $row ['descripcion_dietas']; ?></textarea>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						...
						<a href="crud_dietas.php" class="btn btn-sm btn-danger">Cancelar</a>
					</div>
				</div>
			</form>
		</div>
