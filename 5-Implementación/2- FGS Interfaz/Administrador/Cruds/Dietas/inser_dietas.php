...
<div class="card" style="width: 28rem; background-color:rgba(255, 255, 255, 0.89)"  >
    <div class="card-body" >
        <br>
        <h1 style="color:black;"> Dietas </h1>
        <form method="post" action="controlador_dietas_in.php" >

                <div class="form-group">
                <label for="fecha">id_dietas:</label>
                ...
                <div class="form-group">
                <label for="">Tipo dietas:</label>
                    <input type="text" name="n3" class="form-control"  placeholder="Tipo" style="width: 20rem; background-color:rgb(255, 255, 255); color: black" >
                </div>
                <div class="form-group">
                <label for="">Duracion dietas:</label>
                    <input type="text" name="n4" class="form-control"  placeholder="Duracion" style="width: 20rem; background-color:rgb(255, 255, 255); color: black" required="required">
                </div>
                <div class="form-group">
                <label for="">Descripcion dietas:</label>
                <textarea name="n5" rows="10" cols="50" style="width: 20rem;"></textarea>
                </div>               
                <div class="controls">
            <div align="center"> 
