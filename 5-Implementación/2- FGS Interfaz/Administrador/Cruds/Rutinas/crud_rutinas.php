...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top" style="background-color:rgb(0, 0, 0);">
        ...
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
					...
					<div class="col-6">
					<form action="inser_rutinas.php">
						<button  class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Agregar nueva rutina</span></button>						
					</form>
					</div>
                </div>
            </div>
		<?php
			...
			if(isset($_GET['aksi']) == 'delete'){
				...
				$cek = mysqli_query($con, "SELECT * FROM fgs_rutinas WHERE id_rutinas='$nik'");
				if(mysqli_num_rows($cek) == 0){
					echo '<div class="alert alert-info alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button> No se encontraron datos.</div>';
				}else{
					$delete = mysqli_query($con, "DELETE FROM fgs_rutinas WHERE id_rutinas='$nik'");
					if($delete){
            ...
            <table class="table table-striped table-hover">
                <thead>
                    <tr>
                        <th>Id Rutinas</th>
						<th>Nombre Rutinas</th>
						<th>Repeticiones Rutinas</th>
						<th>Descripcion Rutinas</th>
                    </tr>
                </thead>
                <tbody>
                <?php
                ...
                $sql = mysqli_query($con, $a);
					...
					while($row = mysqli_fetch_assoc($sql)){
						echo '
						<tr>
							<td>'.$row['id_rutinas'].'</td>
							<td>'.$row['nombre_rutinas'].'</td>
							<td>'.$row['repeticiones_rutinas'].'</td>
							<td>'.$row['descripcion_rutinas'].'</td>
							<td>';
							echo '
							<td>
								<a href="edit_rutinas.php?nik='.$row['id_rutinas'].'" title="Editar datos" class="btn btn-primary btn-sm"><i class="material-icons">edit</i></a>
								<a href="crud_rutinas.php?aksi=delete&nik='.$row['id_rutinas'].'" title="Eliminar" onclick="return confirm(\'¿Esta seguro de borrar la cita número '.$row['id_rutinas'].'?\')" class="btn btn-danger btn-sm"><i class="material-icons">delete</i></a>
							</td>
							</tr>
							';
					}
