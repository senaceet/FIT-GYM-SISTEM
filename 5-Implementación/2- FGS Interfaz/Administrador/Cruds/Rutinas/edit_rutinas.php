...
<nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #00000000;" >
	...
	<div class="container">
		<div class="content">
			<h2 style="color: rgb(112, 200, 216)">Editar Rutinas</h2>
			<hr />
			...
			$sql = mysqli_query($con, "SELECT * FROM fgs_rutinas WHERE id_rutinas='$nik'");
			...
			?>
			<form method="post" action="controlador_rutinas_ed.php" >
				<div class="form-group">
					<label class="col-sm-3 control-label" style="color: rgb(112, 200, 216)">ID</label>
					<div class="col-sm-2">
						<input type="text" name="n1" value="<?php echo $row ['id_rutinas']; ?>" class="form-control" required>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-3 control-label" style="color: rgb(112, 200, 216)">Nombre Rutina</label>
					<div class="col-sm-4">
						<input type="text" name="n2" value="<?php echo $row ['nombre_rutinas']; ?>" class="form-control"  required>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-3 control-label" style="color: rgb(112, 200, 216)">Repeticiones Rutina</label>
					<div class="col-sm-4">
						<input type="text" name="n3" value="<?php echo $row ['repeticiones_rutinas']; ?>" class="form-control"  required>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-3 control-label" style="color: rgb(112, 200, 216)">Descripcion rutina</label>
					<div class="col-sm-4">
						<textarea name="n4" rows="10" cols="50" style="width: 20rem;"><?php echo $row ['descripcion_rutinas']; ?></textarea>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						...
						<a href="crud_rutinas.php" class="btn btn-sm btn-danger">Cancelar</a>
					</div>
				</div>
			</form>
		</div>
