...
<div class="card" style="width: 28rem; background-color:rgba(255, 255, 255, 0.89)"  >
    <div class="card-body" >
        <br>
        <h1 style="color:black;"> Rutinas </h1>
        <form method="post" action="controlador_rutinas_in.php" >

                <div class="form-group">
                <label for="fecha">id_rutinas:</label>
                ...
                <div class="form-group">
                <label for="">Nombre rutinas:</label>
                ...
                <div class="form-group">
                <label for="">Repeticiones rutinas:</label>
                    <input type="text" name="n3" class="form-control"  placeholder="Repeticiones" style="width: 20rem; background-color:rgb(255, 255, 255); color: black" >
                </div>
                <div class="form-group">
                <label for="">Descripcion rutinas:</label>
                <textarea name="n4" rows="10" cols="50" style="width: 20rem;"></textarea>
                </div>               
                <div class="controls">
            <div align="center"> 
