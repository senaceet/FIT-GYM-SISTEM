...
<body>
        ...
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
					...
					<div class="col-6">
					<form action="inser_proveedores.php">
						<button  class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Agregar nuevo proveedor</span></button>						
					</form>
					</div>
                </div>
            </div>
		<?php
			...
			if(isset($_GET['aksi']) == 'delete'){
				...
				$cek = mysqli_query($con, "SELECT * FROM fgs_proveedor WHERE id_proveedor='$nik'");
				if(mysqli_num_rows($cek) == 0){
					echo '<div class="alert alert-info alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button> No se encontraron datos.</div>';
				}else{
					$delete = mysqli_query($con, "DELETE FROM fgs_proveedor WHERE id_proveedor='$nik'");
					if($delete){
                ...
                $sql = mysqli_query($con, $a);
					...
					while($row = mysqli_fetch_assoc($sql)){
						...
						<tr>
							...
							<td>'.$row['primer_nombre_proveedor'].'&nbsp;'.$row['segundo_nombre_proveedor'].'&nbsp;'.$row['primer_apellido_proveedor'].'&nbsp;'.$row['segundo_apellido_proveedor'].'</td>
							<td>'.$row['numero_telefono_proveedor'].'</td>
							<td>';
							echo '
							<td>
								<a href="edit_proveedores.php?nik='.$row['id_proveedor'].'" title="Editar datos" class="btn btn-primary btn-sm"><i class="material-icons">edit</i></a>
								<a href="crud_proveedores.php?aksi=delete&nik='.$row['id_proveedor'].'" title="Eliminar" onclick="return confirm(\'¿Esta seguro de borrar la cita número '.$row['id_proveedor'].'?\')" class="btn btn-danger btn-sm"><i class="material-icons">delete</i></a>
							</td>
							</tr>
							';
					}
